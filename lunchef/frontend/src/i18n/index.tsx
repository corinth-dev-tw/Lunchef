...
import { formatTwd, formatTwDate, formatTime } from './formatters'
import type { Locale, TranslateFn } from './types'

export { formatTwd, formatTwDate, formatTime }
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = useCallback<TranslateFn>(
    (key, vars) => {
      ...
      if (value === undefined) {
        // Last resort: return key so missing strings are visible in dev
